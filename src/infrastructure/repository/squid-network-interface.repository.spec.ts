...
describe('NetworkInterfaceRepository', () => {
  ...
  describe(`Get all ip address registered on squid`, () => {
    ...
    it(`Should successfully get all ip address registered (without filter) and return empty records`, async () => {
      ...
      const [error, result, count] = await repository.getAll();console.log(error)
    ...
    it(`Should successfully get all ip address registered (with pagination) and return records`, async () => {
      (<jest.Mock>spawn).mockImplementation(() => {
        const stderr = new PassThrough();
        stderr.end();
        const stdout = new PassThrough();
    ...
    it(`Should successfully get all ip address registered (with sort and pagination) and return records`, async () => {
      (<jest.Mock>spawn).mockImplementation(() => {
        const stderr = new PassThrough();
        stderr.end();
        const stdout = new PassThrough();
    ...
    it(`Should successfully get all ip address registered (with skip pagination) and return records`, async () => {
      (<jest.Mock>spawn).mockImplementation(() => {
        const stderr = new PassThrough();
        stderr.end();
        const stdout = new PassThrough();
